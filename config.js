...
module.exports = {
SESSION_ID: 'HANSAMAL-MD=LB11BQaQ#B0KXaHP2hGwk9UpnWghhcr8tPi-i1ZHH-oSTZ10dN48',
GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? 'YOUR GIT TOKEN (gph_without)' : process.env.GITHUB_AUTH_TOKEN,
GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'crazy-arrow' : process.env.GITHUB_USER_NAME,
